...
const Experience = () => {
  ...
  const clients = [
    "SlotAmerica", "ELK Studios", "Winterstone", "SG Interactive", 
    "Williams Interactive", "Jadestone", "Functional Games", "Paf.com",
    "Aspect Gaming", "Golden Hero", "MTV", "Viasat", "TV3"
  ];
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {clients.map((client, index) => (
                    <span 
                      key={index}
                      className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 text-white px-3 py-1 rounded-full text-sm border border-white/10"
                    >
                      {client}
                    </span>
                  ))}
